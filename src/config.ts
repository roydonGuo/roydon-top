export const site = {
    author: 'roydon',
    slogan: '人需要走多远的路，才能在时光的尽头找寻到真正的自己',
    description: '',
    keywords: '',
    favicon: '/favicon.ico',
    url: 'https://www.roydon.top/'
}
export const footer = {
    beian: {
        enabled: true,
...
export const aboutMe = {
    avatar_url: 'https://gcore.jsdelivr.net/gh/roydonGuo/CDN/avatar/ganyu.webp',
    left_tags: [
        '🤖️ 数码科技爱好者',
        '🔍 分享与热心帮助',
        '💻 前端开发工程师'
